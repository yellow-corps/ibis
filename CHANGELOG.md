...
- SOS Tickets buttons allow for changing the button style.
...
- Added `[@] uniqueinvites list` command to UniqueInvites cog.
...
- Fixed various bugs in Name Changer cog.

## [2.3.0] - 2026-06-07

### Added

- Name Changer cog, to handle... uh... handle change requests.
...
- Bug in export utility when interpreting timezone.
...
[Unreleased]: https://github.com/yellow-corps/ibis/compare/v2.5.0...HEAD
...
[2.3.1]: https://github.com/yellow-corps/ibis/compare/v2.3.0...v2.3.1
[2.3.0]: https://github.com/yellow-corps/ibis/compare/v2.2.1...v2.3.0
[2.2.1]: https://github.com/yellow-corps/ibis/compare/v2.2.0...v2.2.1
[2.2.0]: https://github.com/yellow-corps/ibis/compare/v2.0.0...v2.2.0
